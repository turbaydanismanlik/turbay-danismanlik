  ...
  return (
    <div className="wrapper main">
      <div className={styles.container}>
        <h1>YATIRIM TEŞVİK BELGESİ NEDİR?</h1>
        <div>
          <p>
            ...
            &nbsp;unsurlarından yararlanma imkânı sağlayan ve elektronik ortamda
            düzenlenen bir belgedir.
          </p>
          <p>
            Normal şartlarda yatırım dönemi <b>3 yıllık</b> bir süreyi
            kapsamaktadır. Ancak bu süre içerisinde yatırımların tamamlanamaması
            halinde belgede kayıtlı sürenin yarısı kadar daha ilave süre talep
            edilebilmektedir. Bu durumda yatırımcıların <b>4,5 yıllık</b> bir
            süre içerisinde belgenin kendilerine sağladığı avantajlardan
            yararlanması mümkündür.
          </p>
        </div>
        <h1>
          YATIRIM TEŞVİK SİSTEMİ ve YATIRIM TEŞVİK BELGESİNİN SAĞLADIĞI
          AVANTAJLAR
        </h1>
        <div>
          <p>
          ...
          <p>
            Yatırım teşvik sisteminde birçok yatırım konusu için teşvik belgesi
            düzenlenebilmekle birlikte sistem dışında tutulan yatırım konuları
            da yer almaktadır. Bu alanlar mevzuatta teşvik edilmeyecek ve
            teşviki belli şartlara bağlı yatırım konuları başlığı altında açıkça
            ifade edilmiştir. Desteklenmeyen ve teşviki için öngörülen şartları
            sağlayamayan yatırım konularıyla birlikte bölgesel ve stratejik
            yatırımlar hariç tutulduğunda, yatırımların bölgesinde öngörülen
            asgari sabit yatırım tutarında gerçekleştirilecek olması halinde
            genel destekleme sınıfında belge alınabilecektir.
          </p>
        </div>
        <h1>GENEL DESTEKLİ BELGELERİN YATIRIMCILARA SAĞLADIĞI AVANTAJLAR </h1>
        <div>
          <ul>
        ...
        <h1>BÖLGESEL DESTEKLİ BELGELERİN YATIRIMCILARA SAĞLADIĞI AVANTAJLAR</h1>
        <div>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              <b>
                (3&apos;üncü, 4&apos;üncü, 5&apos;inci ve 6&apos;ncı bölgelerde
        ...
        <h1>STRATEJİK YATIRIMLARDA SAĞLANAN ÖZEL DESTEKLER</h1>
        <div>
          <p>
        ...
        <h1>YATIRIM TEŞVİK BELGESİ DESTEK UNSURLARI</h1>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                <b>
                  gelir veya kurumlar vergisi, sabit yatırım tutarının belli bir
                  oranına ulaşıncaya kadar indirimli olarak uygulanmaktadır
                </b>
                . Belge kapsamında yatırımcılara, sabit yatırım tutarının belli
                bir kısmına kadar vergi ödememe hakkı tanınmaktadır. Örneğin
                4.bölgede gerçekleştirilecek 4 milyon TL tutarındaki bir yatırım
                sonucunda firmanın 1,2 milyon TL vergi indiriminden yararlanma
                hakkı doğacaktır. İlk geçici vergi döneminden itibaren
                yatırımcılar indirim hakkını kullanabileceklerdir. Ayrıca
                yatırım dönemi içerisinde diğer faaliyetlerden elde edilen
                kazançlara da indirimli gelir veya kurumlar vergisi
                uygulanabilmektedir. Belgenin tamamlama vizesi işlemleri için
                başvuru yapılmasıyla birlikte kalan vergi indirim hakkı yeniden
                değerleme oranıyla değerlenerek bir sonraki yıla
                aktarılmaktadır. Bu noktada belge tamamlama vizesi işlemleriyle
                birlikte sadece yatırımdan elde edilen gelirlerin vergi
                indirimine konu edilebileceği, diğer faaliyetlerden elde edilen
                gelirlerde vergi indirim hakkının kullanılamayacağı
                unutulmamalıdır.
              </p>
            </li>
            <li>
              <p>
                ...
                . Komple yeni yatırımlarda belge kapsamında gerçekleşen istihdam
                için, diğer yatırım cinslerinde ise yatırıma başlamadan önceki
                son 6 aylık ortalama sigortalı sayısına ilave olarak yatırım
                kapsamında istihdam edilen sigortalılar için destek
                sağlanmaktadır. İstisnaları olmakla birlikte yatırım teşvik
                belgesinin tamamlama vizesi işlemlerinin yapılmasıyla birlikte
                destekten yararlanılmaya başlanmaktadır. Yatırımın bölgesine
                göre söz konusu destekten&nbsp;
                <b>2 yıldan 12 yıla kadar yararlanılması mümkündür</b>. Destek
                süresi içerisinde her ay, tanımlanan her bir çalışan için brüt
                asgari ücretin %15,5&apos;i kadar destekten yararlanılmaktadır.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                <b>
                  kullanılan kredilerde faizin veya kâr payının belli oranlarda
                  azami 5 yıl süreyle bütçe kaynaklarından karşılanması şeklinde
                  uygulanmaktadır
                </b>
            ...
            <li>
              <p>
                <b>Sigorta Primi Desteği:&nbsp;</b>6&apos;ncı bölgede stratejik
                yatırımlar ve bölgesel teşvik uygulamaları kapsamında
                gerçekleştirilecek yatırımla sağlanan ilave istihdam için
                işveren tarafından ödenmesi gereken&nbsp;
                <b>
                  sigorta primi işçi hissesinin asgari ücrete tekabül eden
                  kısmının tamamlama vizesinin yapılmasını müteakip 10 yıl
                  süreyle Sanayi ve Teknoloji Bakanlığı bütçesinden karşılanması
                  şeklinde uygulanmaktadır
                </b>
                . Öte yandan Teknoloji Odaklı Sanayi Hamlesi Programı kapsamında
                desteklenmesine karar verilen stratejik yatırımlarda 6&apos;ncı
                bölge dışındaki bölgelerde söz konusu destek, yatırıma konu ürün
                yüksek teknoloji seviyesinde ise 7 yıl, diğerlerinde ise 5 yıl
        ...
        <h1>KİMLER YATIRIM TEŞVİK BELGESİ ALABİLİR?</h1>
        <div>
          <ul>
            <li>
              <b>Gerçek kişiler</b>
            ...
            <li>
              <b>Kamu kurum ve kuruluşları</b>&nbsp;(genel ve özel bütçeli kurum
              ve kuruluşlar, il özel idareleri, belediyeler ve kamu iktisadi
              teşebbüsleri ile bunların sermaye bileşimindeki hisse oranları
        ...
        <h1>ASGARİ SABİT YATIRIM TUTARI NE KADARDIR?</h1>
        <div>
          <p>
            Yatırım teşvik sisteminde iller 6 bölge içerisinde
            sınıflandırılmıştır. Yatırım teşvik belgesi düzenlenebilmesi için
            arazi-arsa, bina-inşaat, makine-teçhizat ile diğer yatırım harcaması
            kalemlerinin toplamı;
            <ul>
              <li>
            ...
            asgari kapasite, sabit yatırım tutarı ve yatırımın sağlaması gereken
            başkaca şartlar talep edilebilmektedir.
          </p>
        </div>
        <h1>YATIRIM TEŞVİK KAPSAMINDA SUNDUĞUMUZ HİZMETLER</h1>
        <div>
          <ul>
            <li>
              Yatırımın konu, kapasite, asgari sabit yatırım tutarı ve mevzuatta
              belirlenen diğer şartlar açısından incelenmesi ve&nbsp;
              <b>
            ...
            <li>
              ...
              kayıtlarının yapılması ve yevmiye bilgilerinin sisteme işlenmesi,
              bina-inşaat, arazi-arsa ve diğer yatırım harcamaları için&nbsp;
              <b>
                fatura/beyanname kayıtlarının yapılması ve yevmiye bilgilerinin
                sisteme işlenmesi
              </b>
              ,
            </li>
            ...
            <li>
              ...
              <b>vergi indirim hakkının kullanılabilmesi için süreç yönetimi</b>
              ,
            </li>
            <li>
