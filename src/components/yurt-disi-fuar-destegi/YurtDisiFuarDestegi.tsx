      ...
      >
        ...
        <tbody>
          <tr style={{borderBottom: '1px solid #e7f0df'}}>
            ...
            <td style={{padding: '12px 15px'}}>418.681</td>
          </tr>
          <tr style={{borderBottom: '1px solid #e7f0df'}}>
            <td style={{padding: '12px 15px'}}>Sektörel Nitelikli Fuarlar</td>
            <td style={{padding: '12px 15px'}}>698.317</td>
          </tr>
          <tr style={{borderBottom: '1px solid #e7f0df'}}>
  ...
  return (
    <div className={styles.container}>
      ...
      <div>
        ...
        <p>
          Bir takvim yılında <span>en fazla 2 prestijli fuar</span> desteğinden
          yararlanılabilir.
        </p>
        <p>
